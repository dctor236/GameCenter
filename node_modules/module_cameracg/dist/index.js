...
class CameraAnchor {
    ...
    constructor() { }
    async init() {
        this._anchorObj = await GoPool.getInstance().asyncSpawn(Assets.MESH_BLOCK, GameObjPoolSourceType.Asset);
        this._anchorObj.setVisibility(mw.PropertyStatus.Off);
        this._moveLoc = this._anchorObj.worldTransform.position.clone();
        this.camera = await GameObject.asyncSpawn("Camera");
